package com.yzd.db.temp.dao.conf.mybatis;
...
import com.yzd.db.temp.dao.conf.mybatis.dataSource.DynamicDataSource;
...
@MapperScan(basePackages = "com.yzd.db.temp.dao.mapper")
