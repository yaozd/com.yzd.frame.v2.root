...
public interface JsonResultCodeEnum {
    ...
    enum ERROR  implements JsonResultCodeEnum{
        ...
        InvalidRequestParametersReturnStringError(1001,"请求参数不合法-返回错误信息-暂时不使用-20181217-0945"),
        InvalidRequestParametersReturnJsonError(1002,"请求参数不合法-返回JSON类型的字符串错误信息-返回数据所主要用于页面做数据反显"),
        DataValidFail(1003,"数据有效性验证失败-返回数据主要用于页面弹出提示，在页面不做数据反显"),
